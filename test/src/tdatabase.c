...
int read_database(int read_rec, int c)
{
    ...
    rec_no=read_rec;
    switch(c){
        case 1: file_nm[0]='\0';break;
        case 2: strcpy(filesname,"..\\data\\database\\datacell.csv");  break;
        default: strcpy(filesname,"..\\data\\database\\db.csv");  break;
    };

    strcpy(file_nm,filesname);
...
int insert_database(User insert_new_user)
{
    ...
    rec_no=0;\
    /* Provide test input, which is no file in this case */
    strcpy(file_nm," ");
