...
int identify_user(int a)
{
    int number;
    /* Provide input here instead of asking user */
    switch(a){
...
int new_user(int b)
{
    ...
    /* Provide health card number */
    switch(b){
        case 1:strcpy(Ins_user.health_number,"01234567890"); break;
        case 2: strcpy(Ins_user.health_number,"1234567890"); break;
        default: break;
    };
    ...
    /* Provide the e-mail */
    strcpy(Ins_user.email ,"test@gmail");
...
int old_user(void)
{
    ...
    /* Provide our test input */
    strcpy(health_card,"1122334455");
    fflush(stdin);
    ...
    /* Provide our test input */
    strcpy(email_address,"itsmemario@gmail.ca");
